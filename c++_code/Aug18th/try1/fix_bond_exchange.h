...
class FixBondExchange : public Fix {
 ...
 private:
  ...
  int exchangecount, foursome, exchangecounttotal;
  int nmax, tflag, iatomtype, jatomtype;
  int exchange1, exchange2, naccept1, naccept2;
  ...
  void exchange_angles(int);
  void exchange_dihedrals(int);
  void exchange_impropers(int);
