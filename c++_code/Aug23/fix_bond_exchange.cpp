...
FixBondExchange::FixBondExchange(LAMMPS *lmp, int narg, char **arg) :
  ...
  distsq(nullptr), exchanged(nullptr), copy(nullptr), nextpartner(nullptr), 
  finalnextpartner(nullptr), nextdistsq(nullptr)
{
...
void FixBondExchange::post_integrate()
{
  ...
  double xtmp,ytmp,ztmp,delx,dely,delz,rsq, nextrsq;
